...
must(main.includes("import './arena-stage.css'")||loader.includes("import('./arena-stage.css')"),'Arena stylesheet missing from startup or lazy arena loader')
...
console.log('PASS Arena MX3 contains no prior Arena presentation, Arena stylesheet is present via startup or lazy loader, no FIGHT announcer')
