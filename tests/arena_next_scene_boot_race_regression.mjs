...
const prototypeMain=fs.readFileSync('src/game/arena-next/prototype/main.ts','utf8')
...
for(const [name,source] of [['ArenaNextRuntime',runtime],['live-main',liveMain],['prototype/main',prototypeMain]]){
