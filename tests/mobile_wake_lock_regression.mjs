...
assert(source.includes("wakeLockSentinel.release()"), 'Wake lock must release when the player leaves the arena')
assert(source.includes("document.visibilityState !== 'visible'"), 'Wake lock must not be requested for a hidden tab')
