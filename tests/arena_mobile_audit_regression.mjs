...
const requiredAssets=['card-selected.opus','card-draw.opus','effect-enter-field.opus','card-attacking.opus','card-destroyed.opus','card-goes-to-zon-x.opus','prompt-needed.opus','player-win.opus']
...
console.log('PASS Arena MX3 audit: local-turn prompts, phase glow, card ratios, authoritative SFX, no FIGHT audio')
