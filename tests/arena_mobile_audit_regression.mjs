...
must(pkg.scripts.build.includes('patch-arena-responsive-system.mjs'), 'unified responsive Arena is not in the build chain')
...
must(css.includes('/* MEGA-X unified arena responsive system */'), 'Arena geometry is not owned by unified responsive system')
...
must(css.includes('body:has(.duel-shell) #mx-audio-controls{position:fixed!important'), 'arena audio controls are not isolated in utility layer')
...
console.log('PASS Arena audit: unified geometry, card-game SFX, state-driven draw, sane gains, utility controls, Spudur confirmation')
