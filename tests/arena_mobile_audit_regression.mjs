...
must(fragment.includes("game.phase === 'EFFECT' && game.effectTurn === bottomPlayer"),'local-turn Effect prompt gate missing')
must(fragment.includes("game.phase === 'ATTACK' && game.attackTurn === bottomPlayer"),'local-turn Attack prompt gate missing')
...
console.log('PASS Arena MX3 final lock: supplied VS art/flare, compact prompt, contained opponent hand, dedicated VS-entry SFX, no FIGHT audio')
