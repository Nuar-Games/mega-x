...
must(fragment.includes("game.phase === 'EFFECT' && game.effectTurn === localViewer"),'authoritative local-turn Effect prompt gate missing')
must(fragment.includes("game.phase === 'ATTACK' && game.attackTurn === localViewer"),'authoritative local-turn Attack prompt gate missing')
