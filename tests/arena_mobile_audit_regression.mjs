...
must(buildClean.includes('patch-production-jank-hotfix.mjs'),'production motion/audio hotfix missing')
must(!buildClean.includes('patch-single-fight.mjs'),'obsolete FIGHT patch remains')
