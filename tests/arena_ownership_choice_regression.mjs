...
must(!fragment.includes('mx3-vs-label') && !app.includes('mx3-vs-label'), 'VS card slots must contain no inner text label')
...
console.log('PASS fighter plates are name/rank only, VS slots are text-free, PEMAIN terminology is current, and shared card-choice UI remains authoritative')
