...
assert(app.includes("dispatchOnlineAction('PASS_ATTACK')"), 'online PASS_ATTACK authoritative path missing')
...
console.log('PASS online SET_VS, PLAY_EFFECT, ATTACK and PASS_ATTACK remain wired through the authoritative match-action path')
