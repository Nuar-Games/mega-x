...
assert(css.includes('.mx-lobby-left{grid-row:2!important}'),'ONLINE X FIGHTERS is not promoted ahead of leaderboard on mobile')
assert(css.includes('.mx-leaderboard{grid-row:3!important}'),'Leaderboard is not moved below online roster on mobile')
