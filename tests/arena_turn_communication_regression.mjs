...
must(fragment.includes('mx3-role-label-left'), 'left PEMAIN/LAWAN label missing under Player 1 stats')
must(fragment.includes('mx3-role-label-right'), 'right PEMAIN/LAWAN label missing under Player 2 stats')
must(fragment.includes("activePlayer === 0 ? 'PEMAIN' : 'LAWAN'"), 'Player 1 PEMAIN/LAWAN turn switch missing')
must(fragment.includes("activePlayer === 1 ? 'PEMAIN' : 'LAWAN'"), 'Player 2 PEMAIN/LAWAN turn switch missing')
must(fragment.includes("activePlayer === 0 ? 'is-player-turn' : ''"), 'Player 1 active glow class missing')
must(fragment.includes("activePlayer === 1 ? 'is-player-turn' : ''"), 'Player 2 active glow class missing')
