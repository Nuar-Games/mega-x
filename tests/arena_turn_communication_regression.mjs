...
must(roleRuntime.includes('mx3-role-label-left'), 'left PEMAIN/LAWAN label missing under Player 1 stats')
must(roleRuntime.includes('mx3-role-label-right'), 'right PEMAIN/LAWAN label missing under Player 2 stats')
