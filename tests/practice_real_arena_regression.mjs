...
must(app.includes("from './practice-match'") && app.includes("mega-x:start-practice-match") && app.includes('applyOnlineMatchView(match as any)'), 'practice must enter the existing ActiveOnlineMatch -> Arena rendering path')
